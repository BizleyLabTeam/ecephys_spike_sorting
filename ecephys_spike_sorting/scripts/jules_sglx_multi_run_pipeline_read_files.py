...
#                        ['040422_Trifle_AM', '0', 'start,end','0',['cortex']],
                        # ['07_03_2022_F1903Trifle_14_AM', '0', 'start,end','0',['cortex']],
...
ni_present = True
ni_extract_string = '-XD=4,0,500 -XD=4,5,100'
...
toStream_sync_params = 'SY=0,-1,6,500'  
niStream_sync_params = 'XD=4,0,500'   # copy from ni_extract_string, set to None if no Aux data, no spaces
